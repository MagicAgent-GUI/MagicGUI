...
def get_dataset_dir(data_name):
    ...
    match data_name:
        ...
        case 'gui_odyssey_test':
            data_dir = os.path.join(os.path.dirname(os.path.dirname(data_dir)),"datasets", "eval_data_process", "odyssey")
            data_split = "test"
            data_subset = ["odyssey"]
        case 'android_control_high_test':
            data_dir = os.path.join(os.path.dirname(os.path.dirname(data_dir)),"datasets", "eval_data_process", "android_control_test")
            data_split = "test"
